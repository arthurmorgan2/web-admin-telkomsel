        ...
        <div class="containter-fluid">
            ...
            <div class="row py-4">
                <div class="col-md-12 px-3 filterable-div" data-category="ntebaru">
                    @include('admin.table.table-nte-baru-telkom')
                </div>
                <div class="col-md-12 px-3 filterable-div" data-category="dismantling">
                    @include('admin.table.table-dismantling-telkom')
                </div>
                <div class="col-md-12 px-3 filterable-div" data-category="refurbished">
                    @include('admin.table.table-refurbished-telkom')
                </div>
                <div class="col-md-12 px-3 filterable-div" data-category="total">
                    @include('admin.table.table-total-telkom')
                </div>
            </div>
        </div>
    </div>
