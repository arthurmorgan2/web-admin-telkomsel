        ...
        <thead class="text-center">
            ...
            <tr class="ont-text">
                ...
                <th style="vertical-align : middle;text-align:center; padding:0;" class="bg-warning">
                    ...
                    HG680FJ</th>
                {{-- ZTE --}}
                <th style="vertical-align : middle;text-align:center; padding:0;" class="bg-warning">STB
                    _ZTE_
                    ZX10
                    _B866F_
                    V1.1
                </th>
                <th style="vertical-align : middle;text-align:center; padding:0;" class="bg-warning">STBIPTV
                    _ZTE_
                    B860H
                    _V2.1
                </th>
