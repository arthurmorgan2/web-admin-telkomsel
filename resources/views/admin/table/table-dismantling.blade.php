<div class="container-fluid table-parent">
    ...
    <table class="table table-bordered" id="dataTable">
        <thead class="text-center">
            ...
            <tr class="ont-text">
                ...
                <th style="vertical-align : middle;text-align:center;" class="bg-info">ONT
                    ...
                    F670L</th>
                {{-- Fiberhome --}}
                <th style="vertical-align : middle;text-align:center;" class="bg-warning">
                    SetTopBoxIPTV_FIBERHOME_HG680-P</th>
                <th style="vertical-align : middle;text-align:center;" class="bg-warning">
                    SetTopBoxIPTV_FIBERHOME_HG680FJ</th>
                {{-- ZTE --}}
                <th style="vertical-align : middle;text-align:center;" class="bg-warning">SetTopBox_ZTE_ZX10_B866F_V1.1
                </th>
                <th style="vertical-align : middle;text-align:center;" class="bg-warning">SetTopBoxIPTV_ZTE_B860H_V2.1
                </th>
        ...
        <tbody>
            @for ($i = 0; $i < count($dataDismantling); $i++) <tr>
